...
server '188.166.181.31', user: 'deployer', roles: %w{app web}
...
role :app, %w{deployer@188.166.181.31}
role :web, %w{deployer@188.166.181.31}
role :db,  %w{deployer@188.166.181.31}
